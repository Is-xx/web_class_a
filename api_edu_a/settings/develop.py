"""
Django settings for api_edu_a project.
...
SECRET_KEY = ')!54s(-tj*_tf3377y$ingvo&h0+*@segutsq5)2730puce_tc'
...
WSGI_APPLICATION = 'api_edu_a.wsgi.application'
...
REST_FRAMEWORK = {
    # DRF配置的全局异常处理的方法
    'EXCEPTION_HANDLER': 'api_edu_a.utils.exceptions.exception_handler',
    # 添加认证方式
...
ALIAPY_CONFIG = {
    ...
    "notify_url": "http://lixiang123.com:8000/payments/result/",  # 异步结果通知
}
